...
library(survivalROC)      
setwd("C:\\Users\\dell\\Desktop\\COAD\\8. TCGA inner validation\\3 TCGAtest analysis")     
...
bioSurvival(inputFile="riskTest.txt",outFile="survival.pdf")
...
bioRiskPlot(inputFile="riskTest.txt",heatmapFile="test.heatmap.pdf")
