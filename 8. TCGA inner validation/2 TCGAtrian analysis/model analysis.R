...
library(survivalROC)       
setwd("C:\\Users\\dell\\Desktop\\COAD\\8. TCGA inner validation\\2 TCGAtrian analysis")    
...
bioSurvival(inputFile="riskTrain.txt",outFile="survival.pdf")
...
library(pheatmap)
setwd("C:\\Users\\dell\\Desktop\\biotype and immune\\process\\8. trian analysis")     
...
bioRiskPlot(inputFile="riskTrain.txt",heatmapFile="train.heatmap.pdf")
