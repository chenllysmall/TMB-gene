...
library(survivalROC)      
setwd("C:\\Users\\dell\\Desktop\\COAD\\9. GEO analysis")    
...
bioSurvival=function(inputFile=null,outFile=null){
  ...
  pdf(file=outFile,onefile = FALSE,width = 7,height =5)
  print(surPlot)
  dev.off()
}
bioSurvival(inputFile="Testrisk.txt",outFile="survival.pdf")





inputFile="Testrisk.txt"              
...
bioRiskPlot(inputFile="Testrisk.txt",heatmapFile="test.heatmap.pdf")
